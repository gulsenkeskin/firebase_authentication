...
class CustomInputTheme {
  ...
  InputDecorationTheme theme() => InputDecorationTheme(
        ...
        isDense: true,
        floatingLabelBehavior: FloatingLabelBehavior.always, //never hiç bir zaman göstermez, auto: otaklanıldığında üste kaydırır //always her zaman yukarıda gösterir
